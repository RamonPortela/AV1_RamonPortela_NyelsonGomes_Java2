...
public class MetodosAuxiliares {
	...
	public static void pressionarEnter() {
		...
		input.nextLine();// só continua pro proximo passo se o usuario apertar a
							// tecla enter
	...
	public static void limparTela() {// varias quebras de linha "limpar" o
										// console
		for (int i = 0; i < 25; i++) {
			System.out.println("\n");
		}
	...
	public static boolean checarChassi(String checaChassi,
			ArrayList<Veiculo> comparaVeiculo) {
